export default {
  ...
  'dashboard': {
    ...
    'lastweek': 'gegen letzte Woche',
    'orders': 'Aufträge',
    'customers': 'Kunden',
    'tickets': 'Support-Tickets',
    'viewReport': 'Zeige Bericht'
  },
  'usermenu': {
    'profile': 'Profil',
    'signin': 'Anmelden',
  ...
  'menu': {
    ...
    'ecommerceOrders': 'Aufträge',
    'ecommerceCart': 'Wagen',
    'auth': 'Auth-Seiten',
    'authLogin': 'Anmelden / Anmelden',
    'authRegister': 'Anmelden / Registrieren',
    ...
    'utilityMaintenance': 'Instandhaltung',
